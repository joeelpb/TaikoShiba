			...
			if( ConfigIni.bログ出力 )
			{
				...
				catch ( System.IO.IOException )			// #24481 2011.2.20 yyagi
				{
					...
					string[] mes_writeErr = {
						...
						"Failed to write TJAPlayer3.log. Please set it writable and try again."
					};
					MessageBox.Show( mes_writeErr[c], "TJAPlayer3 boot error", MessageBoxButtons.OK, MessageBoxIcon.Error );
					Environment.Exit(1);
				}
			}
			Trace.WriteLine("");
...
//			this.listトップレベルActivities.Add( stageオプション );
            ...
            #region Discordの処理
            Discord.Initialize("794618989623902219");
