...
namespace TJAPlayer3
{
    ...
    internal class CSkin : IDisposable
    {
        ...
        public Cシステムサウンド soundCoinPrompt = null;
            ...
            get
            {
                switch (sound)
                {
                    ...
                    case Eシステムサウンド.SOUNDCOINPROMPT:
                        return this.soundCoinPrompt;

                    case Eシステムサウンド.SOUNDERROR:
        ...
        public void PrepareReloadSkin()
        {
            ...
            this.soundCoinPrompt = new Cシステムサウンド(@"Sounds\CoinPrompt.ogg", false, false, true, ESoundGroup.Voice);
        ...
        public bool bIsValid(string skinPathFullName)
        {
            ...
            filePathTitle = System.IO.Path.Combine(skinPathFullName, @"Graphics\MenuTitle\Background.png");
        ...
        public int[] SongSelect_NamePlate_X = new int[] { 15, 1028 };
        public int[] SongSelect_NamePlate_Y = new int[] { 601, 601 };
        ...
        public int[] Game_Balloon_Roll_Frame_X = new int[] { 251, 251 };
        public int[] Game_Balloon_Roll_Frame_Y = new int[] { -12, 505 };
        public int[] Game_Balloon_Roll_Number_X = new int[] { 415, 415 };
        public int[] Game_Balloon_Roll_Number_Y = new int[] { 110, 627 };
        ...
        #endregion
        #region PuchiChara
        public int[] Game_PuchiChara_X = new int[] { 130, 130 };
        ...
        public int Game_PuchiChara_Timer = 4000;
