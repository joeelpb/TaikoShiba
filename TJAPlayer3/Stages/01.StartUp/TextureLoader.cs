...
namespace TJAPlayer3
{
    class TextureLoader
    {
        ...
        // Stage
        const string TITLE = @"MenuTitle\";
        const string CONFIG = @"ConfigPanel\";
        const string SONGSELECT = @"SongSelection\";
        const string SONGLOADING = @"LoadingSong\";
        const string GAME = @"GameTextures\";
        const string RESULT = @"ResultScreen\";
        const string EXIT = @"ExitScreen\";
        ...
        public void LoadTexture()
        {
            ...
            NamePlate[0] = TxC(@"Misc/NamePlate.png");
            NamePlate[1] = TxC(@"Misc/NamePlate_2P.png");
            Coin = TxC(@"Misc/MainBlank.png");
            Service = TxC(@"Misc/MainBlank.png");
            #endregion
            #region 1_タイトル画面
           ...
           Title_Menu = TxC(TITLE + @"Menu.png");
            ...
            //title routine 1
            Title_R1_Background = TxC(TITLE + @"Menu.png");
            Title_R1_Logo = TxC(TITLE + @"Menu.png");
           ...
           /* Title_NetworkStatus = new CTexture[3];
            ...
            Config_Background2 = TxC(CONFIG + @"Background2.png");
            ...
            Config_Font_Title = TxC(CONFIG + @"Font_Title.png");
            ...
            Taiko_NamePlate[0] = TxC(GAME + TAIKO + @"NamePlate_1P.png");
            Taiko_NamePlate[1] = TxC(GAME + TAIKO + @"NamePlate_2P.png");
            ...
            #endregion
            #region PuichiChara
            PuchiChara = TxC(GAME + PUCHICHARA + @"puchichara.png");
            #endregion
            #endregion
        ...
        public CTexture Config_Background2,
            //Config_Cursor,
            Config_ItemBox,
            //Config_Arrow,
            Config_KeyAssign,
